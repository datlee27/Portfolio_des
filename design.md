...
## Mission
Create implementation-ready, token-driven UI guidance for Creatie® – Creative Designer Portfolio that is optimized for consistency, accessibility, and fast delivery across e-commerce storefront.
...
- Include known page component density: links (17), buttons (2), lists (1).
